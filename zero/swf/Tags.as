					...
					if(nodeId<nodeCount){
						...
						switch(nodeXML.name().toString()){
							...
							default:
								...
								if(nodeXML.@zhinengSrc.toString()){//20140722
									...
									tag=_initByXMLOptions.getTagByZhinengSrc(nodeXML);
									
								}else if(nodeXML.@dataSrc.toString()){//20140722
									...
									tag=_initByXMLOptions.getTagByDataSrc(nodeXML);
