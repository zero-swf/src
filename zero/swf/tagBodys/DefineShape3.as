	...
	public class DefineShape3{
		...
		//CONFIG::USE_XML{
			...
			public function zhinengToXML(xmlName:String,_toXMLOptions:Object):XML{
				...
				var src:String=_toXMLOptions.saveSWF("形状",this,thisData,ShapeBounds.Xmin/20,ShapeBounds.Ymin/20,(ShapeBounds.Xmax-ShapeBounds.Xmin)/20,(ShapeBounds.Ymax-ShapeBounds.Ymin)/20);
