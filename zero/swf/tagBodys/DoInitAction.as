...
package zero.swf.tagBodys{
	...
	public class DoInitAction{
		...
		public function zhinengToXML(xmlName:String,_toXMLOptions:Object):XML{
			...
			var ActionsXML:XML=Actions.toXML("Actions",_toXMLOptions);
			
			var src:String=_toXMLOptions.saveData("AVM1代码/actions",this,"sprite"+SpriteID,ActionsXML.toXMLString(),"xml");
