		...
		//CONFIG::USE_XML{
			...
			public function zhinengToXML(xmlName:String,_toXMLOptions:Object):XML{
				...
				if(ButtonCondActions){
					...
					var ButtonCondActionssXML:XML=ButtonCondActions.toXML("ButtonCondActions",_toXMLOptions);
					
					var src:String=_toXMLOptions.saveData("AVM1代码/actions",this,id,ButtonCondActionssXML.toXMLString(),"xml");
					
					xml.appendChild(<ButtonCondActions
						xmlSrc={src}
					/>);
