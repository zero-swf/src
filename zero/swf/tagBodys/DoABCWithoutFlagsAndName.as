...
package zero.swf.tagBodys{
	...
	public class DoABCWithoutFlagsAndName{
		...
		public function zhinengToXML(xmlName:String,_toXMLOptions:Object):XML{
			...
			_toXMLOptions.zhinengABCClasses=true;
			var ABCDataXML:XML=ABCData.toXML("ABCData",_toXMLOptions);
			_toXMLOptions.zhinengABCClasses=false;
			
			var src:String=_toXMLOptions.saveData("AVM2代码/abcs",this,null,ABCDataXML.toXMLString(),"xml");
			
			xml.appendChild(<ABCData
				xmlSrc={src}
			/>);
