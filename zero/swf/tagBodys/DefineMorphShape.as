	...
	public class DefineMorphShape{
		...
		//CONFIG::USE_XML{
			...
			public function zhinengToXML(xmlName:String,_toXMLOptions:Object):XML{
				...
				var src:String=_toXMLOptions.saveSWF("形状",this,thisData,StartBounds.Xmin/20,StartBounds.Ymin/20,(StartBounds.Xmax-StartBounds.Xmin)/20,(StartBounds.Ymax-StartBounds.Ymin)/20);
