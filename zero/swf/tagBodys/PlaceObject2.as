		...
		//CONFIG::USE_XML{
			...
			public function zhinengToXML(xmlName:String,_toXMLOptions:Object):XML{
				...
				if(ClipActions){
					...
					var ClipActionsXML:XML=ClipActions.toXML("ClipActions",_toXMLOptions);
					
					var src:String=_toXMLOptions.saveData("AVM1代码/actions",this,null,ClipActionsXML.toXMLString(),"xml");
					
					xml.appendChild(<ClipActions
						xmlSrc={src}
					/>);
