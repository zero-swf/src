...
package zero.swf{
	...
	public class SWF{
		...
		public function infoToBytes(_toDataOptions:Object):ByteArray{
			...
			if(Nbits==31){//20140513
				
				bytes[8]=0xf8|((Xmin>>28)&0x07);
				bytes[9]=Xmin>>20;
				bytes[10]=Xmin>>12;
				bytes[11]=Xmin>>4;
				bytes[12]=((Xmin<<4)&0xf0)|((Xmax>>27)&0x0f);
				bytes[13]=Xmax>>19;
				bytes[14]=Xmax>>11;
				bytes[15]=Xmax>>3;
				bytes[16]=((Xmax<<5)&0xe0)|((Ymin>>26)&0x1f);
				bytes[17]=Ymin>>18;
				bytes[18]=Ymin>>10;
				bytes[19]=Ymin>>2;
				bytes[20]=((Ymin<<6)&0xc0)|((Ymax>>25)&0x3f);
				bytes[21]=Ymax>>17;
				bytes[22]=Ymax>>9;
				bytes[23]=Ymax>>1;
				bytes[24]=(Ymax<<7)&0x80;
